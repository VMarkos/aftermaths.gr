...
Η παραπάνω εικασία είναι γνωστή και ως `εικασία του Collatz  <https://en.wikipedia.org/wiki/Collatz_conjecture>`__. Είδαμε ότι ξεκινώντας από οποιονδήποτε από τους αριθμούς 1,2,...,10 πράγματι καταλήγουμε στον αριθμό 1 - δείτε `εδώ  <docs/After-maths/η-εικασία-collatz-1.rst>`__ για περισσότερα. Ωστόσο, το ότι το δείξαμε για δέκα θετικούς ακεραίους δε σημαίνει επʹουδενί ότι ισχύει η παραπάνω εικασία για *κάθε θετικό ακέραιο αριθμό*. Είναι όμως χρήσιμο να αποκτήσουμε μία διαίσθηση για το πώς μοιάζουν οι ακολουθίες που προκύπτουν από την παραπάνω διαδικασία, καθώς μπορούμε να αποκομίσουμε δύο οφέλη (δυνητικά):
...
Τώρα, το να φτιάξουμε έναν πίνακα όπως αυτό που είδαμε εδώ αλλά όχι μόνο με 10 αλλά, ας πούμε, με 1000 γραμμές, σίγουρα δεν είναι κάτι που θα ήταν διασκεδαστικό να το κάνουμε με το χέρι. Γιʹ αυτό, όμως, έχουμε τον υπολογιστή μας. Η παρακάτω συνάρτηση - σε python - δέχεται έναν θετικό ακέραιο n και παράγει την αντίστοιχη ακολουθία Collatz με αρχικό όρο n:
   ...
   if __name__ == '__main__ʹ:
       ...
       for i in range(1,n+1):
           ...
           for entry in sequence:
               sequences += str(entry) + ' '
           sequences += '\nʹ
       with open('sequenes.txtʹ,'wʹ) as file:
