...
Την προηγούμενη εβδομάδα ξεκινήσαμε να κατασκευάζουμε γραφήματα με βάση την αντίστροφη έκφραση της εικασίας Collatz που είχαμε παρουσιάσει - για μία γρήγορη υπενθύμιση, δείτε :doc:`εδώ  </docs/After-maths/η-εικασία-collatz-3>` και για όλες τις δημοσιεύσεις της σειράς δείτε :doc:`εδώ  </category/collatz/>`. Να θυμίσουμε ότι ο τρόπος κατασκευής του γραφήματος είναι ο εξής:
