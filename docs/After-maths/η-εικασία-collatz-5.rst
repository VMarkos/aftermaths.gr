...
*Για να θυμηθείτε όσα είπαμε την προηγούμενη εβδομάδα, δείτε*\ `εδώ  <docs/After-maths/η-εικασία-collatz-4.rst>`__\ *, ενώ για όλες τις αναρτήσεις της σειράς, δείτε*\ `εδώ  <https://aftermaths.gr/category/collatz/>`__\ *.*
