...
Αν  :math:`f,g`  είναι δύο συναρτήσεις ορισμένες και παραγωγίσιμες κοντά σε κάποιο  :math:`x_0\in\mathbb{R}`  έτσι ώστε  :math:`\lim_{x\to x_0}f(x)=\lim_{x\to x_0}g(x)=0`  και το όριο  :math:`\lim_{x\to x_0}\frac{fʹ(x)}{gʹ(x)}`  υπάρχει και είναι είτε πραγματικός αριθμός είτε άπειρο, τότε ισχύει και ότι  :math:`\lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{fʹ(x)}{gʹ(x)}.` 
...
Αν  :math:`f,g`  είναι δύο συναρτήσεις ορισμένες και παραγωγίσιμες κοντά σε κάποιο  :math:`x_0\in\mathbb{R}`  έτσι ώστε  :math:`\lim_{x\to x_0}f(x)=\lim_{x\to x_0}g(x)=\pm\infty`  και το όριο  :math:`\lim_{x\to x_0}\frac{fʹ(x)}{gʹ(x)}`  υπάρχει και είναι είτε πραγματικός αριθμός είτε άπειρο, τότε ισχύει και ότι  :math:`\lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{fʹ(x)}{gʹ(x)}.` 
