...
.. container:: wp-block-image
   ...
   .. figure:: /_static/images/uploads/2020/03/screenshot_2020-03-01-desmos-graphing-calculator1.png
...
.. math:: f(x)=Fʹ(x)=\left\{\begin{array}{ll}2x\sin\frac{1}{x}-\cos\frac{1}{x} & x\neq0\0 & x=0\end{array}\right..

Και τώρα, η στιγμή της αλήθειας. Ας δούμε τη γραφική παράσταση της  :math:`f=Fʹ` :

.. figure:: /_static/images/uploads/2020/03/screenshot_2020-03-01-desmos-graphing-calculator2.png
...
.. math:: \left(x^2\sin\dfrac{1}{x}\right)'&=(x^2)'\sin\dfrac{1}{x}+x^2\left(\sin\dfrac{1}{x}\right)'\\ &=2x\sin\dfrac{1}{x}+x^2\cos\dfrac{1}{x}\left(\dfrac{1}{x}\right)'\\ &=2x\sin\dfrac{1}{x}+x^2\cos\dfrac{1}{x}\left(-\dfrac{1}{x^2}\right)\\ &=2x\sin\dfrac{1}{x}-\cos\dfrac{1}{x}.
...
.. container:: wp-block-image
   ...
   .. figure:: /_static/images/uploads/2020/03/screenshot_2020-03-02-desmos-graphing-calculator.png
...
.. math:: f(x)=Fʹ(x)=\left\{\begin{array}{ll}2x\sin\frac{1}{x^2}-\frac{2}{x}\cos\frac{1}{x^2} & x\neq0\0 & x=0\end{array}\right..

Η γραφική παράσταση της παραγώγου είναι:

.. figure:: /_static/images/uploads/2020/03/screenshot_2020-03-02-desmos-graphing-calculator1.png
...
Εδώ τα πράγματα είναι πάρα πολύ απλά. Όπως έχουμε δει και :doc:`εδώ  </docs/After-maths/μια-εφαρμογή-του-de-lhospital-στην-παραγωγισιμ>` - και μας έχει πει και ο :doc:`Darboux  </docs/Διδακτικό-Υλικό/Γ-ΓΕΛ/Μαθηματικά/Επανάληψη/η-ιδιότητα-darboux-ο-rolle-το-άτοπο-και-μία-λάθος-α>` - υπάρχουν αρκετές «απλές» συναρτήσεις που δεν έχουν παράγουσα. Μία από αυτές είναι η:
...
.. math::  gʹ(t)=\frac{d}{dt}\int_0^{\pi/2}\frac{\arctan(t\tan x)}{\tan x}dx=\int_0^{\pi/2}\frac{\partial}{\partial t}\frac{\arctan(t\tan x)}{\tan x}dx.

Παραγωγίζουμε προσεκτικά ως προς  :math:`t`  τη συνάρτηση μέσα στο ολοκλήρωμα, οπότε παίρνουμε:

.. math::  gʹ(t)=\int_0^{\pi/2}\frac{\tan x\left(\arctan\right)'(t\tan x)}{\tan x}dx=\int_0^{\pi/2}\left(\arctan\right)'(t\tan x)dx.

Τώρα, χρησιμοποιούμε το γεγονός ότι  :math:`(\arctan)'(t)=\dfrac{1}{1+t^2}` , έχουμε:

.. math::  gʹ(t)=-\int_0^{\pi/2}\frac{1}{1+(t\tan x)^2}dx=\int_0^{\pi/2}\frac{1}{1+t^2\tan^2x}dx.
...
.. math::  gʹ(t)=\int_0^\infty\frac{1}{(1+u^2)(1+t^2u^2)}du,
...
.. math::  gʹ(t)=\int_0^\infty-\frac{t^2}{(1-t^2)(1+t^2u^2)}+\frac{1}{(1-t^2)(1+u^2)}du,

το οποίο μπορεί να σπάσει σε δύο απλούστερα ολοκληρώματα:

.. math::  gʹ(t)=-\frac{t^2}{1-t^2}\int_0^\infty\frac{1}{1+t^2u^2}du+\frac{1}{1-t^2}\int_0^\infty\frac{1}{1+u^2}du.
...
.. math:: \int_0^\infty\frac{1}{1+t^2u^2}du&=\int_0^{\pi/2}\frac{1}{t\cos^2s(1+\tan^2s)}ds=\\ &=\int_0^{\pi/2}\frac{1}{t}ds=\\ &=\frac{\pi}{2t}.

Επομένως, μετά κόπων και βασάνων, έχουμε βρει ότι, για  :math:`t\neq\pm1`  και  :math:`t\neq0` :

.. math::  gʹ(t)=-\frac{t^2}{1-t^2}\frac{\pi}{2t}+\frac{\pi}{2}\frac{1}{1-t^2}=\frac{\pi}{2}\frac{1-t}{1-t^2}=\frac{\pi}{2}\frac{1}{1+t}.

Συνοψίζοντας όλα τα παραπάνω, έχουμε βρει ότι:

.. math:: gʹ(t)=\left\{\begin{array}{ll}\frac{\pi}{2}\frac{1}{1+t} & t\neq0,\pm1\\pi/4 & t=\pm1\\pi/2 & t=0\end{array}\right.,
