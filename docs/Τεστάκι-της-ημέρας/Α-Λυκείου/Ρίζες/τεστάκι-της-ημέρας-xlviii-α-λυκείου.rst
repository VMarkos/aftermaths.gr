Τεστάκι της ημέρας XLVIII (Αʹ Λυκείου)
######################################
...
.. meta::
	...
	:tags: ρίζες, τεστ, Αʹ Λυκείου, άλγεβρα, ασκήσεις, επανάληψη
	:slug: %cf%84%ce%b5%cf%83%cf%84%ce%ac%ce%ba%ce%b9-%cf%84%ce%b7%cf%82-%ce%b7%ce%bc%ce%ad%cf%81%ce%b1%cf%82-xlviii-%ce%b1-%ce%bb%cf%85%ce%ba%ce%b5%ce%af%ce%bf%cf%85
	:status: published
...
Το τεστ μπορείτε να το βρείτε `εδώ  <https://drive.google.com/file/d/1vPo7eaFY0psXSefIwjC8DPLwYQ3pCQRw/view?usp=sharing>`__ και στη σελίδα του :doc:`διδακτικού υλικού  </docs/Διδακτικό-Υλικό/index>`.
