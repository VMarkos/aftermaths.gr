...
*Για τα σχήματα της προηγούμενης εβδομάδας, όπου και παρουσιάσαμε την πρώτη μας βιβλιοθήκη του ``tikz`` δείτε*\ `εδώ  <docs/Tikz/τα-σχήματα-της-εβδομάδας-5.rst>`__\ *, ενώ όλες τις αναρτήσεις της σειράς μπορείτε να τις βρείτε*\ `εδώ  </category/tikz/>`__\ *.*
