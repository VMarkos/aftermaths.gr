...
*Για τα σχήματα της προηγούμενης εβδομάδας δείτε*\ `εδώ  <docs/Tikz/τα-σχήματα-της-εβδομάδας-6.rst>`__\ *ενώ για όλες τις αναρτήσεις της σειράς δείτε*\ `εδώ  </category/tikz/>`__\ *.*
