...
.. figure:: /_static/images/uploads/2021/11/david98.jpg
...
Τα προβλήματα μπορείτε να τα βρείτε `εδώ  <https://drive.google.com/file/d/1Z9uLRbCCL0PJacn94woq1usgOzLuNwbt/view?usp=sharing>`__ και στις ασκήσεις του :doc:`διδακτικού υλικού  </docs/Διδακτικό-Υλικό/index>`.

*Εισαγωγικές ασκήσεις στην έννοια της συνέχειας μπορείτε να βρείτε*\ :doc:`εδώ  </docs/Διδακτικό-Υλικό/Γ-ΓΕΛ/Μαθηματικά/Συνέχεια/εισαγωγή-στη-συνέχεια>`\ *.*
