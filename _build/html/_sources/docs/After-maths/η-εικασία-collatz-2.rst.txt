...
Στο :doc:`πρώτο μέρος της σειράς  </docs/After-maths/η-εικασία-collatz-1>` είδαμε τη διατύπωση μίας αρκετά ενδιαφέρουσας εικασίας:
...
Η παραπάνω εικασία είναι γνωστή και ως :doc:`εικασία του Collatz  <https://en.wikipedia.org/wiki/Collatz_conjecture>`. Είδαμε ότι ξεκινώντας από οποιονδήποτε από τους αριθμούς 1,2,...,10 πράγματι καταλήγουμε στον αριθμό 1 - δείτε :doc:`εδώ  </docs/After-maths/η-εικασία-collatz-1>` για περισσότερα. Ωστόσο, το ότι το δείξαμε για δέκα θετικούς ακεραίους δε σημαίνει επʹουδενί ότι ισχύει η παραπάνω εικασία για *κάθε θετικό ακέραιο αριθμό*. Είναι όμως χρήσιμο να αποκτήσουμε μία διαίσθηση για το πώς μοιάζουν οι ακολουθίες που προκύπτουν από την παραπάνω διαδικασία, καθώς μπορούμε να αποκομίσουμε δύο οφέλη (δυνητικά):
