...
Για να αποδείξουμε την  :math:`\phi `  υποθέτουμε την  :math:`\neg\phi`  και έπειτα από πεπερασμένο αριθμό συλλογισμών καταλήγουμε σε μία αντίφαση.
...
Για να αποδείξουμε την  :math:`\neg\phi`  υποθέτουμε την  :math:`\phi`  και έπειτα από πεπερασμένο αριθμό συλλογισμών καταλήγουμε σε μία αντίφαση.
...
Αν υποθέσουμε ότι δεν αληθεύει ότι  :math:`a=0`  τότε  :math:`a\neq0.` 
