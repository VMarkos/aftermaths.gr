Μια εφαρμογή του de LʹHospital στην παραγωγισιμότητα
####################################################
...
.. meta::
	...
	:tags: featured, παράγωγος, πανελλήνιες, Γʹ λυκείου
...
Αν  :math:`f `  είναι μία συνάρτηση ορισμένη σε ένα διάστημα  :math:`(a,b)`  η οποία είναι παραγωγίσιμη σε αυτό με εξαίρεση ίσως ένα σημείο  :math:`x_0\in(a,b)` , για το οποίο όμως γνωρίζουμε ότι  :math:`\lim\limits_{x\to x_0}fʹ(x)=\ell` . Τότε η  :math:`f`  είναι παραγωγίσιμη στο  :math:`x_0`  με  :math:`fʹ(x_0)=\ell` .
...
.. math:: fʹ(x)=\left\{\begin{array}{ll}3x^2 & x>0\2x & x<0\end{array}\right.

Επίσης, εύκολα βλέπουμε ότι το όριο  :math:`\lim\limits_{x\to x_0}fʹ(x)=0`  επομένως, από το παραπάνω έχουμε αμέσως ότι  :math:`fʹ(0)=0` .

Να κάνουμε και κάποιες παρατηρήσεις για το παραπάνω:

-  Αρχικά, το παραπάνω λήμμα μας λέει κάτι πιο ζουμερό από αυτό που βλέπουμε. Αν το ερμηνεύσουμε λίγο διαφορετικά, μας λέει ότι αν μία συνάρτηση είναι παραγωγίσιμη εκατέρωθεν ενός σημείου και έχει όριο σε αυτό τότε είναι *συνεχής* σε αυτό - αφού και υπάρχει εκεί η παράγωγος και είναι ίση με το όριο της  :math:`fʹ` .
...
-  Ένα βήμα παρακάτω, ας παρατηρήσουμε ότι το παραπάνω λήμμα δεν καλύπτει όλες τις περιπτώσεις, υπό την έννοια ότι υπάρχουν συναρτήσεις που είναι παραγωγίσιμες σε όλο το πεδίο ορισμού τους, ωστόσο δεν υπάρχει το όριο της παραγώγου τους σε κάποιο σημείο - άρα δεν ικανοποιούνται οι υποθέσεις του παραπάνω λήμματος. Ίσως το πιο κλασσικό παράδειγμα να είναι η συνάρτηση:
   ...
   .. math:: fʹ(x)=\left\{\begin{array}{ll}2x\sin\frac{1}{x}-\cos\frac{1}{x}&x\neq0\0&x=0\end{array}\right.
...
.. figure:: /_static/images/uploads/2020/01/screenshot_2020-01-02-desmos-graphing-calculator.png
