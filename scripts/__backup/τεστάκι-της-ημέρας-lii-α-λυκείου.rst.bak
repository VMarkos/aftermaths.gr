Τεστάκι της ημέρας LII (Α' Λυκείου)
###################################
:date: 2021-01-25 09:12
:author: aftermathsgr
:category: Διδακτικό υλικό, Μαθηματικά, Τεστάκι της ημέρας
:tags: ρίζες, τεστ, Α' Λυκείου, ΕΠΑΛ, άλγεβρα, ασκήσεις, επανάληψη, μαθηματικά
...
Η κεντρική εικόνα είναι το πορτραίτο του Ivan Shishkin του `Ivan Kramskoi <https://en.wikipedia.org/wiki/Ivan_Kramskoi>`__\ *.*
