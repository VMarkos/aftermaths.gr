...
Αυτήν την εβδομάδα είχαμε πολύ περισσότερα πράγματα να δούμε από ότι την προηγούμενη </home/bill/Documents/Projects/aftermaths/__export/scripts/__content/Tikz/τα-σχήματα-της-εβδομάδας-4.rst>`__. Για την ακρίβεια, ήρθε επιτέλους ( ; ) η ώρα να μιλήσουμε για βιβλιοθήκες του ``tikz``. Αλλά, ας τα πάρουμε ένα-ένα...
