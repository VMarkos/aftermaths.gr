...
.. meta::
	...
	:status: published
	:attachments: _static/images/uploads/2021/09/1896_polenow_christus_unter_den_lehrern_anagoria.jpg

.. figure:: /_static/images/uploads/2021/09/1896_polenow_christus_unter_den_lehrern_anagoria.jpg
...
*Για τα σχήματα της προηγούμενης εβδομάδας δείτε*\ `εδώ  <docs/Tikz/τα-σχήματα-της-εβδομάδας-6.rst>`__\ *ενώ για όλες τις αναρτήσεις της σειράς δείτε*\ `εδώ  <https://aftermaths.gr/category/tikz/>`__\ *.*
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/fig_35.png?w=723
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/fig_36.png?w=723
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/fig_37.png?w=723
   :alt: Σχεδόν το ίδιο...
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/fig_38.png?w=723
   :alt: Τ' είν' αυτό;
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/fig_39.png?w=723
   :alt: Σύνθετο σχήμα...
...
Αυτά για αυτήν την εβδομάδα! Την επόμενη Τρίτη, αν δεν έχετε ήδη πάρει μία γεύση από `εδώ  <docs/Tikz/ένα-σχήμα-την-ημέρα.rst>`__, έχουμε πολύ κομψά σχήματα να μελετήσουμε!
