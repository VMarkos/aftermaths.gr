...
Την προηγούμενη εβδομάδα ξεκινήσαμε να κατασκευάζουμε γραφήματα με βάση την αντίστροφη έκφραση της εικασίας Collatz που είχαμε παρουσιάσει - για μία γρήγορη υπενθύμιση, δείτε `εδώ  <docs/After-maths/η-εικασία-collatz-3.rst>`__ και για όλες τις δημοσιεύσεις της σειράς δείτε `εδώ  <https://aftermaths.gr/category/collatz/>`__. Να θυμίσουμε ότι ο τρόπος κατασκευής του γραφήματος είναι ο εξής:
...
#. Επαναλαμβάνουμε τα ακόλουθα επ' άπειρον για κάθε κόμβο ``n`` που βρίσκεται στη λίστα των τρεχόντων κόμβων και έχει ετικέτα που *δεν βρίσκεται στη λίστα ετικετών*:
...
.. container:: wp-block-image
   ...
   .. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/image.png?w=532
...
.. container:: wp-block-image
   ...
   .. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/image-1.png?w=917
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/image-3.png?w=945
...
.. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/image-4.png?w=956
...
.. container:: wp-block-image
   ...
   .. figure:: https://aftermaths.gr/_static/images/uploads/2021/09/image-5.png?w=627
