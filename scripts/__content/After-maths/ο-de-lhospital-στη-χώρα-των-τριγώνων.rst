...
.. figure:: {static}wp-content/uploads/2022/11/best_approx.png
   :alt: Ζουμ, ζουμ, ζουμ!
...
Αν  :math:`f,g&fg=362e77&bg=d9d9d9`  είναι δύο συναρτήσεις ορισμένες και παραγωγίσιμες κοντά σε κάποιο  :math:`x_0\in\mathbb{R}&fg=362e77&bg=d9d9d9`  έτσι ώστε  :math:`\lim_{x\to x_0}f(x)=\lim_{x\to x_0}g(x)=0&fg=362e77&bg=d9d9d9`  και το όριο  :math:`\lim_{x\to x_0}\frac{f'(x)}{g'(x)}&fg=362e77&bg=d9d9d9`  υπάρχει και είναι είτε πραγματικός αριθμός είτε άπειρο, τότε ισχύει και ότι  :math:`\lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{f'(x)}{g'(x)}.&fg=362e77&bg=d9d9d9` 
...
.. figure:: {static}wp-content/uploads/2022/11/best_approx_01.png
   :alt: Δύο συναρτήσεις...
...
.. figure:: {static}wp-content/uploads/2022/11/best_approx_02.png
...
.. figure:: {static}wp-content/uploads/2022/11/dlh_f_g-1.png
...
.. math:: \dfrac{Ax}{Bx}=\dfrac{f'(x_0)}{g'(x_0)}.

Συνεπώς, θα ισχύει και ότι:

.. math:: \lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{(Ax)}{(Bx)}=\frac{f'(x_0)}{g'(x_0)},
...
.. math:: \lim_{x\to x_0}\frac{f(x)}{g(x)}=\frac{f'(x_0)}{g'(x_0)}.

Ο αντίστοιχος κανόνας DLH λέει κάτι αρκετά γενικότερο, ωστόσο:

.. math:: \lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{f'(x)}{g'(x)}.
...
.. figure:: {static}wp-content/uploads/2022/11/best_approx_03.png
...
.. figure:: {static}wp-content/uploads/2022/11/best_approx_04.png
...
.. math:: \lim_{x\to x_1}\frac{f(x)}{g(x)}=\lim_{x\to x_1}\frac{f'(x)}{g'(x)}.
...
Αν  :math:`f,g&fg=362e77&bg=d9d9d9`  είναι δύο συναρτήσεις ορισμένες και παραγωγίσιμες κοντά σε κάποιο  :math:`x_0\in\mathbb{R}&fg=362e77&bg=d9d9d9`  έτσι ώστε  :math:`\lim_{x\to x_0}f(x)=\lim_{x\to x_0}g(x)=\pm\infty&fg=362e77&bg=d9d9d9`  και το όριο  :math:`\lim_{x\to x_0}\frac{f'(x)}{g'(x)}&fg=362e77&bg=d9d9d9`  υπάρχει και είναι είτε πραγματικός αριθμός είτε άπειρο, τότε ισχύει και ότι  :math:`\lim_{x\to x_0}\frac{f(x)}{g(x)}=\lim_{x\to x_0}\frac{f'(x)}{g'(x)}.&fg=362e77&bg=d9d9d9` 
...
.. figure:: {static}wp-content/uploads/2022/11/infty_approx_01.png
...
.. figure:: {static}wp-content/uploads/2022/11/infty_approx_02.png
...
.. math:: \lim_{x\to x_1}\frac{f(x)}{g(x)}\approx\lim_{x\to x_1}\frac{f'(x)}{g'(x)}.

Τώρα, αφού, όπως επιχειρηματολογήσαμε και παραπάνω, τι  :math:`x_1`  τι  :math:`x_0,`  το ένα και το αυτό για εμάς, μπορούμε να πούμε:

.. math:: \lim_{x\to x_0}\frac{f(x)}{g(x)}\approx\lim_{x\to x_0}\frac{f'(x)}{g'(x)}.
