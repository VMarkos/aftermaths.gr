...
Στο πρώτο μέρος της σειράς </home/bill/Documents/Projects/aftermaths/__export/scripts/__content/After-maths/η-εικασία-collatz-1.rst>`__ είδαμε τη διατύπωση μίας αρκετά ενδιαφέρουσας εικασίας:
...
Η παραπάνω εικασία είναι γνωστή και ως εικασία του Collatz <https://en.wikipedia.org/wiki/Collatz_conjecture>`__. Είδαμε ότι ξεκινώντας από οποιονδήποτε από τους αριθμούς 1,2,...,10 πράγματι καταλήγουμε στον αριθμό 1 - δείτε `εδώ </home/bill/Documents/Projects/aftermaths/__export/scripts/__content/After-maths/η-εικασία-collatz-1.rst>`__ για περισσότερα. Ωστόσο, το ότι το δείξαμε για δέκα θετικούς ακεραίους δε σημαίνει επ'ουδενί ότι ισχύει η παραπάνω εικασία για *κάθε θετικό ακέραιο αριθμό*. Είναι όμως χρήσιμο να αποκτήσουμε μία διαίσθηση για το πώς μοιάζουν οι ακολουθίες που προκύπτουν από την παραπάνω διαδικασία, καθώς μπορούμε να αποκομίσουμε δύο οφέλη (δυνητικά):
...
.. figure:: https://aftermaths.gr/wp-content/uploads/2021/04/ceb5ceb9cebacf8ccebdceb1.png?w=1024
